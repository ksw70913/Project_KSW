										...
										success : function(response) {
											...
											for ( var k in resultpoisData) {
												...
												innerHtml += "<li><img src='https://tmapapi.tmapmobility.com/upload/tmap/marker/pin_b_m_" + k + ".png' style='vertical-align:middle;'/><span>"
														+ "<span>"
														+ name
											            + "<button class='btn_start' onclick='setStartLocation(\"" + name + "\", \"" + lat + "\", \"" + lon + "\")'>출발지 지정</button>"
											            + "<button class='btn_start' onclick='setEndLocation(\"" + name + "\", \"" + lat + "\", \"" + lon + "\")'>목적지 지정</button>"
											            + "</li>";
...
<div class="searchroad">
    <input type="text" class="text_custom" id="start" name="start" placeholder="출발지">
    <input type="hidden" id="start_lat" name="start_lat">
    <input type="hidden" id="start_lon" name="start_lon">
    <input type="text" class="text_custom" id="end" name="end" placeholder="목적지">
