...
<body>
	...
	<form name="form1" method="POST" action="./doPlus">
		...
		<input type="submit" value="더하기v1" /> <input onclick="callByAjax();" type="button" value="더하기v2" /> <input
			onclick="callByAjaxV2();" type="button" value="더하기v3" /> <input onclick="callByAjaxV3();" type="button"
			value="더하기v4" /> <input onclick="callByAjaxV4();" type="button" value="더하기v5" />
	</form>
