					...
					oncomplete : function(data) {
						...
						if (data.autoRoadAddress) {
							var expRoadAddr = data.autoRoadAddress
									+ extraRoadAddr;
							guideTextBox.innerHTML = '(예상 도로명주소: '
									+ expRoadAddr + ')';
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="text" id="postcode" name="postcode" placeholder="우편번호" readonly
							...
							<input type="text" id="extraAddress" placeholder="참고항목" readonly> <input type="hidden" id="latitude"
							name="latitude" value="${rq.loginedMember.latitude }" readonly> <input type="hidden" id="longitude"
							name="longitude" value="${rq.loginedMember.longitude }" readonly></td>
					</tr>
					<tr>
						<th>학교급</th>
